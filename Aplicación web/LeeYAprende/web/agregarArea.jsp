    ...
    <head>
        ...
        <script type="text/javascript" charset="utf-8">
            function validate(form) {
                ...
                if (e['nombre'].value == null || e['nombre'].value == "") {m += '- Por favor ingrese el nombre de el área.\n';}
                if (e['nombre'].value.length > 45) {m += '- El nombre del área es demasiado largo\n';}
    ...
    <body>
        ...
        <div class="container" style="padding-top: 45px; padding-bottom: 80px;">
            ...
            <div class="col-md-10 cuerpo">
                ...
                <form class="form-horizontal" method="post" action="CRUDArea?action=insertar" accept-charset="ISO-8859-1" onsubmit="return validate(this);">
                    <fieldset>
                ...
                <table id="tabla" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            List<Area> area = aDao.consultar();

                            for (int i = 0; i < area.size(); i++) {
                                Area temporal = area.get(i);

                                int id = temporal.getIdAreas();
                                String nombre= temporal.getNombreArea();
                                boolean estado= temporal.isEstado();
                        %>        
                        <tr>
                            ...
                            <td>
                                <% if (estado) {%>
                                <form method="post" action="CRUDArea?action=eliminar">
                                    <input type="hidden" name="id"
                                           value="<%=id%>" />
                                    <button type="submit">Eliminar</button>
                                </form>
                                <% } else {%>
                                <form method="post" action="CRUDArea?action=recuperar">
                                    <input type="hidden" name="id"
                                           value="<%=id%>" />
                            ...
                            <td>
                                <form method="post" action="actualizarArea.jsp" accept-charset="ISO-8859-1">
                                    <input type="hidden" name="id"
                                           value="<%=id%>" />
