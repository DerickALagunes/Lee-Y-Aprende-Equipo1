    ...
    <head>
        ...
        <script type="text/javascript" charset="utf-8">
            function validate(form) {
                ...
                if (e['titulo'].value == null || e['titulo'].value == "") {
                    m += '- El título es obligatorio.\n';
                }
                if (e['isbn'].value == null || e['isbn'].value == "") {
                    m += '- El ISBN es obligatorio.\n';
                }
                if (e['pags'].value == null || e['pags'].value == "") {
                    m += '- El número de páginas es obligatorio.\n';
                }
                if (e['autor'].value == null || e['autor'].value == "") {
                    m += '- Debe ingresar por lo menos 1 autor.\n';
                }
                if (e['editorial'].value == null || e['editorial'].value == "") {
                    m += '- La editorial es obligatoria.\n';
                }
                if (e['area'].value == null || e['area'].value == "") {
                    m += '- El área es obligatorio.\n';
                }

                if (e['titulo'].value.length > 45) {
                    m += '- El título es demasiado largo.\n';
                }
                if (e['isbn'].value.length > 17) {
                    m += '- El ISBN no deberia tener mas de 17 caracteres\n';
                }
                if (e['pags'].value.length > 45) {
                    m += '- Son demasiadas páginas.\n';
                }
            ...
            <div class="col-md-10 cuerpo">
                ...
                <form form class="form-horizontal" action="CRUDLibro?action=insertar" method="post" onsubmit="return validate(this);" accept-charset="ISO-8859-1">
                    <fieldset>
                        ...
                        <!-- Text input-->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="pags">Número de páginas</label>  
                            <div class="col-md-6">
                                <input id="pags" name="pags" type="number" placeholder="campo requerido*" class="form-control input-md">
