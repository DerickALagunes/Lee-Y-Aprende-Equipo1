<%-- 
    Document   : error
    Created on : 06-ago-2014, 8:50:55
    Author     : Derick
--%>
    ...
    <body>
        ...
        <div class="container" style="padding-top: 45px; padding-bottom: 80px;">
            ...
            <div class="col-md-4 cuerpo" >
                <legend style="text-align: center">Error</legend>
                <p>Ocurrio un error inesperado, quizas:</p<br />
                <p>-Ocurrió algo muy malo.</p>
                <p>-La dirección de la página esta mal escrita.</p>
                <p>-Algun valor esta mal ingresado.</p>
                <p>-Intento hacer algo ilegal.</p>
