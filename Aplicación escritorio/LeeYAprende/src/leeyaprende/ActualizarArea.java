...
public class ActualizarArea extends javax.swing.JFrame {
    ...
    public ActualizarArea(int idArea){
        initComponents();       
        setLocationRelativeTo(this);
                
        AreaDao daoA = new AreaDao();
        Area area = daoA.consultarPorId(idArea);
        area.getNombreArea();
        jTextField1.setText(area.getNombreArea());
        this.idArea = idArea;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!jTextField1.getText().equals("")){
            ...
            AreaDao daoA = new AreaDao();
            if(daoA.modificar(idArea, area)){
                JOptionPane.showMessageDialog(this, "Área actualizada");
                AltaArea altAr = new AltaArea();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarArea().setVisible(true);
            }
        });
    }
