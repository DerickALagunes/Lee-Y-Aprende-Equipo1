 ...
 * @author rosa
 */
public class AltaEjemplar extends javax.swing.JFrame {
    ...
    AltaEjemplarM altem = new AltaEjemplarM();
    ...
    public AltaEjemplar() {
        ...
        List<String> libros = daoL.consultarNombre();
        for (int i = 0; i < libros.size(); i++) {
            jComboBox1.addItem(libros.get(i));
        }

        List<Ejemplar> ejemplares = daoE.consultar();
        altem.LlenarTabla(ejemplares);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Título", "Localización ", "Numero de Ejemplares"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jComboBox1.getSelectedItem().equals("Libro") && !jTextField1.getText().equals("")) {
            ...
            for (int i = 0; i < numEjemplares; i++) {
                if (daoE.insertar(ejemplar, idLibro)) {
                    flag = true;
                } else {
            ...
            if (flag) {
                JOptionPane.showMessageDialog(this, "Ejemplar insertado");
                altem.LimpiarCampos();
                List<Ejemplar> ejemplares = daoE.consultar();
                altem.LlenarTabla(ejemplares);
            }
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        ...
        List<Ejemplar> ejemplares = daoE.consultaAvanzada(busqueda);
        altem.LlenarTabla(ejemplares);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaEjemplar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaEjemplar().setVisible(true);
            }
        });
    }
    ...
    public class AltaEjemplarM {

        public void LlenarTabla(List<Ejemplar> ejemplares) {
            modelo = (DefaultTableModel) jTable1.getModel();
            for (int i = 0; i < ejemplares.size(); i++) {
                Ejemplar temporal = ejemplares.get(i);
                String[] fila = new String[3];
                fila[0] = temporal.getLibro().getTitulo();
                fila[1] = temporal.getLocalizacion();
                fila[2] = temporal.getNumeroEjemplares() + "";
                modelo.addRow(fila);
                ListaIds.add(temporal.getIdEjemplar());
            }
        }

        public void LimpiarCampos() {
            jComboBox1.setSelectedItem("Libro");
            jTextField1.setText("");
            jTextField2.setText("");
            while (modelo.getRowCount() > 0) {
            modelo.removeRow(0);
